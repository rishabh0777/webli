...
export default function HorizontalScrollText() {
  useGSAP(() => {
    const cards = [
      ...
      { id: "#card4", endTranslateX: -1800, rotate: -45 },
      { id: "#card5", endTranslateX: -1500, rotate: 30 },
    ];
  ...
  return (
    <section className="relative w-full h-[200vh] overflow-hidden">
      <section className="wrapper absolute top-0 w-[1200vw] h-[80vh] will-change-transform sm:p-[15em]">
        <h1 className="text-[48vw] font-black whitespace-nowrap text-center">
